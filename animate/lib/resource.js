 ...
 *        ...}
     ...
     *     caching.
     *   - **`timeout`** 鈥� `{number}` 鈥� timeout in milliseconds.<br />
     *     **Note:** In contrast to {@link ng.$http#usage $http.config}, {@link ng.$q promises} are
     *     **not** supported in $resource, because the same value would be used for multiple requests.
     *     If you are looking for a way to cancel requests, you should use the `cancellable` option.
     *   - **`cancellable`** 鈥� `{boolean}` 鈥� if set to true, the request made by a "non-instance" call
     ...
     *   - **`cancellable`** 鈥� {boolean} 鈥� If true, the request made by a "non-instance" call will be
 ...
 *    }]);
    ...
    provider('$resource', function() {
         ...
         *
         * - **stripTrailingSlashes** 鈥� `{boolean}` 鈥� If true, then the trailing slashes from any
